...
//    }
    ...
    private void seedJob() {
        ...
        jobRepository.save((new Job(3L, 2L, 3L, 3L,
                ...
                800.0, 1, DateUtil.setDateLong(-38), DateUtil.setDateLong(-38), 1)));
        jobRepository.save((new Job(4L, 3L, 1L, 1L,
                ...
                700.0, 1, DateUtil.setDateLong(-35), DateUtil.setDateLong(-35), 1)));
        jobRepository.save((new Job(5L, 3L, 2L, 3L,
                ...
                600.0, 1, DateUtil.setDateLong(-30), DateUtil.setDateLong(-30), 1)));
